...
def get_args_parser():
    ...
    # Meta-Task Construction Settings1
    ...
    parser.add_argument('--model', default='MetaDETR', help='whether to cache images on memory')
    return parser
...
def main(args):
    ...
    if args.resume:
        if args.resume.startswith('https'):
            ...
            del checkpoint['model']['task_positional_encoding.tpe']
    ...
    print("Start initializing rich text feature...")
    print("Finish initializing rich text feature...")
